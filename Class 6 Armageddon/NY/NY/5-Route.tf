resource "aws_route_table" "new_york_private" {
...
resource "aws_route_table" "new_york_public" {
  vpc_id = aws_vpc.new_york.id
...
resource "aws_route_table_association" "private-us-east-1a" {
  ...
  route_table_id = aws_route_table.new_york_private.id
}
...
resource "aws_route_table_association" "public-us-east-1a" {
  ...
  route_table_id = aws_route_table.new_york_public.id
}
